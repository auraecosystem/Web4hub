...
`gh >_$ npm install --global smee-client`
...
```js
const webhookProxyUrl = "[$ npm install --save smee-client](https://smee.io/A4WjBKTutrXD8ZK)"; // replace with your own Webhook Proxy URL
...
const smee = new SmeeClient({
  source: 'https://smee.io/A4WjBKTutrXD8ZK',
...
```env
WEBHOOK_PROXY_URL=https://smee.io/A4WjBKTutrXD8ZK
```
> ## TypeScript
